...
exports.static = function createElementStatic (t, pnode) {
...
exports.state = function createElementState (t, state, type, subs, tree, id, pid, order) {

  console.error(tree._key, node, id, pnode, pid)
