...
exports.property = (t, div, param) => {
  const props = t.staticProps ||
    (t.staticProps = t.filter(t => t && !t.isElement && isStatic(t)))
...
exports.element = (t, div) => {
  const elements = t.staticElements ||
    (t.staticElements = t.filter(t => t && t.isElement && isStatic(t)))
