...
test('events - context - nested', t => {
  ...
  if (!isNode) document.body.appendChild(app)

  trigger(app.childNodes[0].childNodes[0], 'mousedown')
  t.equals(count, 1, 'fires once for correct instance')
  t.end()
})
