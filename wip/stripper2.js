const fs = require('fs')
const original = fs.readFileSync(__dirname + '/bridge-build.js')
...
fs.writeFileSync(__dirname + '/bridge.min.js', str)

const uglifyJS = require('uglify-js')

const file = uglifyJS.minify(__dirname + '/bridge.min.js', {
  compress: {
    dead_code: true,
    sequences: true,
    properties: true,
